import type { CatInfo, MusicCardInfo } from './model/interface'

export const byAppleMusic: MusicCardInfo[] = [
  {
    picUrl:
      'https://p2.music.126.net/GvYQoflE99eoeGi9jG4Bsw==/109951165375336156.jpg',
    name: 'Happy Hits',
    id: 5278068783,
    subText: 'By Apple Music',
  },
  {
    picUrl:
...
export const playlistCategories: CatInfo[] = [
  {
    name: '全部',
    enable: true,
    bigCat: 'static',
